...
export const deviceStatusEnum = pgEnum('device_status', ['pending_approval', 'active', 'blocked', 'decommissioned']);
...
export const alertTypeEnum = pgEnum('alert_type', ['chain_break', 'root_detected', 'long_offline', 'balance_mismatch', 'suspicious_activity', 'unauthorized_device', 'unauthorized_operator']);
